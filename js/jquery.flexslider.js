  ...
  $.flexslider = function(el, options) {
    ...
    methods = {
      init: function() {
        ...
        if (slider.vars.customDirectionNav !== "") slider.customDirectionNav =
          $(slider.vars.customDirectionNav).length === 2 && $(slider.vars
            .customDirectionNav);
          ...
          if (!msGesture) {
            ...
            slider.slides.each(function() {
              ...
              that.addEventListener("MSGestureTap", function(e) {
                ...
                var $slide = $(this),
                  target = $slide.index();
                if (!$(slider.vars.asNavFor).data('flexslider')
                  .animating && !$slide.hasClass('active')) {
                  slider.direction = (slider.currentItem <
                    target) ? "next" : "prev";
                  slider.flexAnimate(target, slider.vars.pauseOnAction,
                    false, true, true);
                }
      ...
      controlNav: {
            ...
            for (var i = 0; i < slider.pagingCount; i++) {
              ...
              if ('thumbnails' === slider.vars.controlNav && true ===
                ...
                if ('' !== captn && undefined !== captn) {
                  item += '<span class="' + namespace + 'caption">' +
                    captn + '</span>';
                }
              }
        ...
        active: function() {
          slider.controlNav.removeClass(namespace + "active").eq(slider
            .animatingTo).addClass(namespace + "active");
        },
        update: function(action, pos) {
          if (slider.pagingCount > 1 && action === "add") {
            slider.controlNavScaffold.append($('<li><a href="#">' +
              slider.count + '</a></li>'));
      ...
      directionNav: {
        setup: function() {
          var directionNavScaffold = $('<ul class="' + namespace +
            'direction-nav"><li class="' + namespace +
            'nav-prev"><a class="' + namespace + 'prev" href="#">' +
            slider.vars.prevText + '</a></li><li class="' + namespace +
        ...
        update: function() {
          ...
          if (slider.pagingCount === 1) {
            slider.directionNav.addClass(disabledClass).attr('tabindex',
              '-1');
          ...
          onTouchEnd = function(e) {
            ...
            if (slider.animatingTo === slider.currentSlide && !
              ...
              if (slider.canAdvance(target) && (Number(new Date()) -
                ...
                if (!fade) {
                  slider.flexAnimate(slider.currentSlide, slider.vars
                    .pauseOnAction, true);
                }
              }
            }
          ...
          function onMSPointerDown(e) {
            ...
            if (slider.animating) {
              ...
              offset = (carousel && reverse && slider.animatingTo ===
                ...
                (carousel) ? ((slider.itemW + slider.vars.itemMargin) *
                  slider.move) * slider.currentSlide :
                (reverse) ? (slider.last - slider.currentSlide + slider
                  .cloneOffset) * cwidth : (slider.currentSlide +
                  slider.cloneOffset) * cwidth;
            }
          }
              ...
              if (!fade && slider.transitions) {
                if (!slider.vars.animationLoop) {
                  dx = accDx / ((slider.currentSlide === 0 && accDx < 0 ||
                    slider.currentSlide === slider.last && accDx >
      ...
      smoothHeight: function(dur) {
        if (!vertical || fade) {
          ...
          }, dur).css('overflow', 'visible'): $obj.innerHeight(slider
            .slides.eq(slider.animatingTo).innerHeight());
        }
      },
      ...
      if (!slider.animating && (slider.canAdvance(target, fromNav) ||
        ...
        if (!fade) {
          ...
          if (carousel) {
            ...
            1 && slider.vars.animationLoop && slider.direction !== "next"
          ) {
          ...
          if (!touch) {
            ...
            slider.slides.eq(target).css({
              ...
              "display": "block"
                ...
                "opacity": 1
              }, slider.vars.animationSpeed, slider.vars.easing, slider
              .wrapup);
          ...
          posCalc = (function() {
            if (carousel) {
              return (special === "setTouch") ? pos :
                ...
                (reverse) ? slider.limit - (((slider.itemW + slider
